          ...
          <section className="space-y-4 pt-1">
            ...
            <div className="space-y-3">
              {skillsData.whatIDo.map((item, i) => (
                <div
                  key={i}
                  className="flex gap-4 items-start p-4 rounded-2xl border border-[hsl(var(--sky)/0.1)] bg-[hsl(var(--sky)/0.02)] backdrop-blur-sm hover:bg-[hsl(var(--sky)/0.05)] transition-colors group"
                >
